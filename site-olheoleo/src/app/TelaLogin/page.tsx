...
import AuthenticationBody from "./Componentes/AuthenticationBody/AuthenticationBody"

export default function TelaLogin() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-white text">
      <div className=" border-slate-100 dark:bg-slate-500 dark:border-slate-500 border-b rounded-xl p-4 pb-6 sm:p-10 sm:pb-8 lg:p-6 xl:p-10 xl:pb-8 space-y-3 sm:space-y-8 lg:space-y-6 xl:space-y-8">
